...
class ServiceGenerator {
    ...
    genFile() {
        ...
        if (!this.config.splitDeclare) {
            ...
            // 创建存放声明文件的文件夹
            const typesDir = path_1.join(finalPath, 'types');
            if (!fs_1.existsSync(typesDir)) {
                fs_2.default.mkdirSync(typesDir, { recursive: true });
            }
            // 按tag生成多个类型声明文件
            ...
            if (tagTypes[tag].length > 0) {
                ...
                if (tagApiData) {
                    tagApiData.forEach(api => {
                        ...
                        if (props.length > 0) {
                            tagTypes[tag].push({
                                typeName: this.getTypeName(Object.assign(Object.assign({}, api), { method: api.method, path: api.path })),
                                type: 'Record<string, any>',
                                parent: undefined,
                                props: [props],
                                isEnum: false,
    ...
    findTagsUsingType(typeName) {
        ...
        Object.keys(this.apiData).forEach(tag => {
            ...
            const isUsed = tagApis.some(api => {
                var _a, _b, _c, _d;
                if (api.parameters) {
                    return api.parameters.some((param) => {
                        var _a, _b, _c;
                        const resolvedParam = this.resolveRefObject(param);
                        return ((_b = (_a = resolvedParam.schema) === null || _a === void 0 ? void 0 : _a.$ref) === null || _b === void 0 ? void 0 : _b.includes(typeName)) || ((_c = resolvedParam.$ref) === null || _c === void 0 ? void 0 : _c.includes(typeName));
                    });
                }
                if (api.requestBody) {
                    ...
                    if (resolvedBody.content) {
                        ...
                        const schema = (_a = resolvedBody.content[mediaType]) === null || _a === void 0 ? void 0 : _a.schema;
                        if ((_b = schema === null || schema === void 0 ? void 0 : schema.$ref) === null || _b === void 0 ? void 0 : _b.includes(typeName)) {
                            return true;
                        }
                    }
                }
                if (api.responses) {
                    ...
                    if (response === null || response === void 0 ? void 0 : response.content) {
                        ...
                        const schema = (_c = response.content[mediaType]) === null || _c === void 0 ? void 0 : _c.schema;
                        if ((_d = schema === null || schema === void 0 ? void 0 : schema.$ref) === null || _d === void 0 ? void 0 : _d.includes(typeName)) {
                            return true;
                        }
                    }
                }
    ...
    getDefinesType(result) {
        if (result.type) {
            return result.type === 'object' || result.type;
        }
        return 'Record<string, any>';
    }
}
